 ...
 * @param layoutManager: Recylerview dizilimi için verilen Layout Manager. Örn: Horizontal, Vertical ve Grid. Default verticaldır
 * @param dividerItemDecoration: Seperator olarak verilen itemdir
 * @param column: Her satırda bulunacak item sayısını belirtir
 */
@JvmOverloads
...
/**
 * Recylerview'da sayfada en aşağıda gelindiğinde tetiklenmek için kullanılır. Pagenation yapılır
 * @param pagenated: En aşağıya geldiğinde çağırılan yeri tetiklemek için kullanılır
 */
 ...
 */
fun AppCompatImageView.changeColor(activity: Activity, color: Int? = R.color.exo_edit_mode_background_color) {
    this.setColorFilter(
